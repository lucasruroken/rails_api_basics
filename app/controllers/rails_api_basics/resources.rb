module RailsApiBasics
  class Resources < BaseController
    ...
    def index
      ...
      render json: serializer.new(@objects, include: serializer_index_includes).serialized_json
    end
    ...
    def show
      render json: serializer.new(@object, include: serializer_show_includes).serialized_json
    end
